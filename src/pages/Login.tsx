        ...
        <div className="bg-card rounded-3xl shadow-soft p-8 border border-border/50">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-foreground mb-2">
              Selamat Datang di MPJ Apps! 👋
            </h1>
            <p className="text-muted-foreground">
              Silakan masuk ke akun Anda untuk memulai
            </p>
          </div>
          ...
          <form className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="email" className="text-foreground">Email atau No. HP</Label>
              <Input
                id="email"
                type="text"
            ...
            <Button type="submit" className="w-full h-12 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-semibold shadow-soft">
              Masuk
            </Button>
          </form>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 rounded-xl border-border/50 hover:bg-secondary/50 transition-colors"
          >
